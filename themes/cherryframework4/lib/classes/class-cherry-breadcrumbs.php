...
if ( ! class_exists( 'cherry_breadcrumbs' ) ) {
	...
	class cherry_breadcrumbs {
		 ...
		 */
		// PHP 8.0+ deprecates optional-before-required parameters. $label has
		// no default, so $format was already implicitly required; every call
		// site passes it explicitly. Drop the default to align the signature
		// with what PHP already enforces.
		public function _add_item( $format, $label, $url = '', $class = '' ) {
