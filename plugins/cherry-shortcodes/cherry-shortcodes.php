<?php
/**
 * Plugin Name: Cherry Shortcodes (TheFarEdge-2026)
 * Plugin URI:  https://github.com/waywardtech/cherry-legacy-suite
 * Description: A pack of WordPress shortcodes. Maintenance fork by SitesFareEdge — PHP 8.2/8.4 and WordPress 6.7+ compatibility patches. Original by Cherry Team.
 * Version:     1.0.7.7
...
if ( !class_exists( 'Cherry_Shortcodes' ) ) {
	...
	class Cherry_Shortcodes {
		...
		function constants() {
			 ...
			 * @since 1.0.0
			 */
			define( 'CHERRY_SHORTCODES_VERSION', '1.0.7.7' );
