<?php
/**
 * Plugin Name: Cherry Team (TheFarEdge-2026)
 * Plugin URI:  https://github.com/waywardtech/thefaredge-space-wp-dev
 * Description: A team management plugin for WordPress. Maintenance fork by SitesFareEdge — PHP 8.2/8.4 and WordPress 6.7+ compatibility patches. Original by Cherry Team.
 * Version:     1.0.9
...
if ( ! class_exists( 'Cherry_Team' ) ) {
	...
	class Cherry_Team {
		...
		public function __construct() {
			...
			// WP 6.7+ requires load_plugin_textdomain() to fire on `init` or later;
			// calling it on `plugins_loaded` triggers a _doing_it_wrong notice.
		...
		function constants() {
			 ...
			 * @since 1.0.0
			 */
			define( 'CHERRY_TEAM_VERSION', '1.0.9' );
		 ...
		 * @return mixed
		 */
		public static function get_meta( $post_id = null, $name = null, $default = false ) {
